...
if (isset($_POST['update'])) {
    ...
    if (!isset($_POST['s_no']) || empty($_POST['s_no'])) {
        echo json_encode(array('error' => 'Options ID is missing.'));
        exit;
        ...
        echo json_encode(array('error' => 'Footer text Field is Empty.'));
        exit;
    } elseif (!isset($_POST['currency_format']) || empty($_POST['currency_format'])) {
        echo json_encode(array('error' => 'Currency Format Field is Empty.'));
        exit;
    } elseif (!isset($_POST['site_desc']) || empty($_POST['site_desc'])) {
        echo json_encode(array('error' => 'Description Field is Empty.'));
        exit;
        ...
        echo json_encode(array('error' => 'Site Logo Field is Empty.'));
        exit;
    } else {
